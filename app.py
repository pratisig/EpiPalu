...
with tab6:
    ...
    <div class="section-card">
        <h1 style="text-align:center;">📘 Guide d'Utilisation Complete</h1>
        <p style="text-align:center;">EpiPalu Predict</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with glossary_tabs[0]:
        st.markdown("### Variables temporelles", unsafe_allow_html=True)

    with glossary_tabs[1]:
        st.markdown("### Variables historiques", unsafe_allow_html=True)

    with glossary_tabs[2]:
        st.markdown("""
        <div class="info-card">
            <h4>🌡️ Temperature (temp_api)</h4>
            <p>Temperature moyenne hebdomadaire</p>
        </div>
        <div class="info-card">
            <h4>🌧️ Precipitations (precip_api)</h4>
            <p>Cumul hebdomadaire des pluies</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="section-card">
        ...
        <p style="text-align:center;">
            📧 youssoupha.mbodji@example.com<br>
            📖 Documentation & FAQ
        </p>
    </div>
    """, unsafe_allow_html=True)
